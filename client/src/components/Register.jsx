...
const Register = () => {
    ...
    const handleSubmit=async(e)=>{
          e.preventDefault();
          try{
             const result=await axios.post("http://localhost:7000/api/register",{username,email,password});
            localStorage.setItem("name",result?.data?.NewUser?.username);
                ...
                <form className="row g-3 needs-validation"  onSubmit={(e)=>handleSubmit(e)}>
                  ...
                  <div className="col-12">
                    ...
                    <div className="input-group has-validation">
                      ...
                      <input type="text" name="username" className="form-control" id="yourUsername" onChange={(e)=>setUsername(e.target.value)} required />
